...
public class SampleLinkedTableAdapter extends LinkedAdaptiveTableAdapter<ViewHolderImpl> {
    ...
    public ViewHolderImpl onCreateItemViewHolder(@NonNull ViewGroup parent) {
        DetailsViewHolder details = new DetailsViewHolder(parent);
        TestImageView test = new TestImageView();
        test.setDetailsViewHolder(details);
    ...
    public void onBindViewHolder(@NonNull ViewHolderImpl viewHolder, int row, int column) {
        ...
        TestImageView testImageView = new TestImageView();
        testImageView.setmTableDataSource(mTableDataSource);
        testImageView.setDataRow(row);
        testImageView.setDataColumn(column);
        testImageView.setViewHolder(viewHolder);
